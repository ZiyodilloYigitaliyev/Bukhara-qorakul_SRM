...
Revision ID: c73b8256f571
Revises: 
Create Date: 2025-09-15 00:44:01.266872
...
def upgrade() -> None:
    ...
    sa.Column('room_slug', sa.String(length=255), nullable=False),
    ...
    sa.UniqueConstraint('room_slug', 'sender_role', 'sender_id', 'client_msg_id', name='uq_msg_dedupe')
    )
    op.create_index(op.f('ix_chat_messages_id'), 'chat_messages', ['id'], unique=False)
    op.create_index(op.f('ix_chat_messages_room_slug'), 'chat_messages', ['room_slug'], unique=False)
    op.create_index('ix_chat_messages_room_time', 'chat_messages', ['room_slug', 'created_at'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index('ix_chat_messages_room_time', table_name='chat_messages')
    op.drop_index(op.f('ix_chat_messages_room_slug'), table_name='chat_messages')
